  ...
  return (
    <div className='mb-2' data-testid="post" >
      ...
      <form className='d-flex justify-content-between align-items-center'>
        <div className='d-flex justify-content-start' data-testid='Delete'>
          <a onClick={(e) => postDeleteRequest(e)} className="text-danger me-1" type="submit" href="/" title='Delete'>
          ...
          <div className={postState === 'display' ? 'd-none' : 'd-flex'}>
            <input onChange={(e) => onPostChange(e)} className='form-control-sm' value={newPost}/>
