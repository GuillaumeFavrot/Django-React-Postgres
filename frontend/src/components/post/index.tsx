    ...
    <div className='mb-2' aria-label="post" >
      ...
      <form className=''>
        <div className='' >
          ...
          <p onClick={() => setToModification()} className={postState === 'display' ? 'mb-0 d-block' : 'd-none'} aria-label="post-text">
            {text}
          </p>
          <div className={postState === 'display' ? 'd-none' : 'd-flex'} aria-label="post-update">
            <input onChange={(e) => onPostChange(e)} className='' value={newPost} aria-label="post-update-input"/>
            <a onClick={(e) => postModification(e)} className='' type="submit" href="/" aria-label="post-update-submit">
