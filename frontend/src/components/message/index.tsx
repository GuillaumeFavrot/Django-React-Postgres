...
export default function MessageComponent({_id, text}: Message) {
  ...
  const messageDeleteRequest = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    e.preventDefault()
    ...
    <div className='mb-2'>
      ...
      <form className='d-flex justify-content-between align-items-center'>
        <div className='d-flex justify-content-start'>
          <a onClick={(e) => messageDeleteRequest(e)} className="text-danger me-1" type="submit" href="/">
          ...
          <div className={messageState === 'display' ? 'd-none' : 'd-flex'}>
            <input onChange={(e) => onMessageChange(e)} className='form-control-sm' value={newMessage}/>
